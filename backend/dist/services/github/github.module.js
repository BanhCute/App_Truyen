...
exports.GithubModule = GithubModule = __decorate([
    (0, common_1.Module)({
        controllers: [github_controller_1.GithubOauthController],
        providers: [jwt_service_1.JwtAuthService, users_service_1.UsersService, github_strategy_1.GithubOauthStrategy],
    })
], GithubModule);
